        ...
        <div className="home-page">
            ...
            <div className="text-white text-3xl md:text-5xl p-4 text-center">
                ...
                <div className="mt-5 character-container">
                    ...
                    />
                    <div className="">
                        <p className="pb-3">Sigmund Freud, The Father of Psychoanalysis</p>
                        <p className="text-2xl">
                ...
                <div className="mt-5 character-container">
                    ...
                    />
                    <div className="">
                        <p className="pb-3">Alexander, The Sage of Mirage Visions</p>
                        <p className="text-2xl">
                ...
                <div className="mt-5 character-container">
                    ...
                    />
                    <div className="">
                        <p className="pb-3">Luna, The Cosmic Dream Catcher</p>
                        <p className="text-2xl">
