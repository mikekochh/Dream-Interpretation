...
const DreamMeaningHome = () => {
    ...
    return (
        <div className="md:w-2/3 md:mx-auto md:px-0 md:py-8 px-3 py-8 bg-transparent main-content">
            <h3 className="text-center font-thin golden-ratio-2 text-gray-200">Most Common Dreams</h3>
            <h2 className="text-center gradient-title-text golden-ratio-4">In-Depth Dream Meanings</h2>
...
export default DreamMeaningHome;