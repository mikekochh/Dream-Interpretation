...
export default function FeedbackForm() {
    ...
    return (
        <div className="text-white text-center p-4 main-content golden-ratio-2 md:w-2/3 md:mx-auto">
        {!feedbackSuccessful ? (
            <div>
                ...
                <button className="start-button-small" onClick={submitFeedback}>Submit</button>
            </div>
        ) : (
            <div className="flex flex-col middle-content">
                <p className="p-2">Thank you for your feedback!</p>
                <button className="dream-button" onClick={() => router.push('/')}>Home</button>
            </div>
        )}
