...
export async function POST(req) {
    ...
    try {
        ...
        usersNotSubscribed.forEach(user => {
                        ...
                        <table style="width: 100%; text-align: center; margin: auto; background-color: #ffffff; border-radius: 10px; color: #000000; box-sizing: border-box; overflow: hidden;">
                            ...
                            <tr>
                                <td valign="top" style="text-align: center; color: #000000; padding: 5%; overflow: auto;">
                                    <h1 style="color: #000000;">Hello Bro!</h1>
                                    ...
                                    <!-- Link at the bottom -->
                                    <h3 style="color: #000000;"><a href="${domain}/interpret" style="text-decoration: none; color: #000000;">Explore Dream Oracles & Interpret Your Dreams</a></h3>
                                </td>
                            </tr>
                        </table>
                    </div>
